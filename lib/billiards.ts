...
export type BilliardsTransactionRow = {
  ...
  paid_at: string;
  // ذات معنى فقط عندما collected_by='cashier': وقت تأكيد موظف البلياردو استلامه
  // النقد فعلياً من الكاشير (حالة نادرة). يبقى null طالما لم يستلمه الموظف بعد.
  // معاملات collected_by='billiards' تبقى بحوزة الموظف مباشرةً بلا حاجة لأي تأكيد هنا
  handed_over_at: string | null;
  // وقت تأكيد المدير استلامه دخل اليوم نقداً من موظف البلياردو من لوحة التحكم
  // الرئيسية — تُسوَّى كل المعاملات "بحوزة الموظف" دفعة واحدة (سواء جمعها الموظف
  // مباشرة أو استلمها من الكاشير) لا لكل معاملة على حدة. يبقى null حتى تسوية المدير
